...
def clear_board(board: Board) -> None:
    for row_const in [ROW_8, ROW_7, ROW_6, ROW_5, ROW_4, ROW_3, ROW_2, ROW_1]:
...
def test_cannot_castle_through_check() -> None:
    ...
    board.set_piece(
        get_square_constant(2, 5), create_piece(Color.BLACK, PieceType.ROOK)
    )
...
def test_cannot_castle_into_check() -> None:
    ...
    board.set_piece(
        get_square_constant(2, 6), create_piece(Color.BLACK, PieceType.ROOK)
    )
...
def test_cannot_castle_after_king_moved() -> None:
    ...
    assert board.make_move(get_square_constant(0, 4), get_square_constant(1, 4)) is True
...
def test_cannot_castle_after_rook_moved() -> None:
    ...
    assert board.make_move(get_square_constant(0, 7), get_square_constant(0, 6)) is True
...
def test_white_en_passant_legal_example() -> None:
    ...
    board.set_piece(
        get_square_constant(7, 3), create_piece(Color.BLACK, PieceType.PAWN)
    )  # Black pawn on d7
    ...
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(7, 3), get_square_constant(2, 4)) is True
    assert board.get_piece(get_square_constant(7, 3)) is None
    assert board.get_piece_type_at(get_square_constant(2, 4)) == PieceType.PAWN
    assert board.get_color_at(get_square_constant(2, 4)) == Color.BLACK
...
def test_black_en_passant_legal_example() -> None:
    ...
    assert board.make_move(get_square_constant(7, 4), get_square_constant(5, 4)) is True
    assert board.en_passant_target == get_square_constant(6, 4)

    # White captures en passant from d2 to e4
    board.turn = Color.WHITE
    assert board.make_move(get_square_constant(1, 3), get_square_constant(3, 4)) is True
    assert board.get_piece(get_square_constant(1, 3)) is None
    assert board.get_piece_type_at(get_square_constant(3, 4)) == PieceType.PAWN
    assert board.get_color_at(get_square_constant(3, 4)) == Color.WHITE
...
def test_en_passant_expires_after_one_turn() -> None:
    ...
    board.set_piece(
        get_square_constant(1, 0), create_piece(Color.WHITE, PieceType.ROOK)
    )
    board.set_piece(
        get_square_constant(7, 7), create_piece(Color.BLACK, PieceType.ROOK)
    )
    ...
    assert board.make_move(get_square_constant(7, 3), get_square_constant(5, 3)) is True
    assert board.en_passant_target == get_square_constant(6, 3)
    ...
    assert board.make_move(get_square_constant(7, 7), get_square_constant(7, 6)) is True

    assert board.make_move(get_square_constant(1, 4), get_square_constant(6, 3)) is True
...
def test_en_passant_unavailable_if_last_move_not_two_step_pawn_move() -> None:
    ...
    _setup_kings(board)
    board.set_piece(
        get_square_constant(2, 4), create_piece(Color.WHITE, PieceType.PAWN)
    )
    board.set_piece(
    ...
    assert board.en_passant_target is None
    assert (
        board.is_valid_pawn_move(get_square_constant(2, 4), get_square_constant(1, 3))
        is False
    )
...
def test_en_passant_cannot_be_used_if_it_leaves_own_king_in_check() -> None:
    ...
    board.set_piece(
        get_square_constant(0, 3), create_piece(Color.BLACK, PieceType.PAWN)
    )
    board.set_piece(
    ...
    assert board.make_move(get_square_constant(0, 3), get_square_constant(3, 3)) is True
    assert (
        board.make_move(get_square_constant(1, 4), get_square_constant(0, 3)) is False
    )
    board.set_piece(
        get_square_constant(7, 4), create_piece(Color.BLACK, PieceType.ROOK)
    )
    ...
    assert board.make_move(get_square_constant(0, 3), get_square_constant(3, 3)) is True
    assert board.make_move(get_square_constant(1, 4), get_square_constant(3, 3)) is True
...
def test_black_promotion_to_queen() -> None:
    ...
    )  # Row 7 = rank 7 (black pawn starting position)
    board.turn = Color.BLACK
...
def test_default_promotion_is_queen_when_unspecified() -> None:
    ...
    assert board.make_move(get_square_constant(0, 4), get_square_constant(7, 4)) is True
    assert board.get_piece_type_at(get_square_constant(7, 4)) == PieceType.QUEEN


def test_parse_move_notation_supports_promotion_choice() -> None:
    move = parse_move_notation("e7e8q")
    assert move.start == get_square_constant(0, 4)
...
def test_cannot_castle_if_rook_captured_on_original_square() -> None:
    ...
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(7, 7), get_square_constant(0, 7)) is True
...
def test_castling_right_persists_after_rook_moved_then_returns() -> None:
    ...
    board.turn = Color.WHITE
    assert board.make_move(get_square_constant(0, 6), get_square_constant(0, 7)) is True
...
def test_castling_kingside_with_queenside_rook_only() -> None:
    ...
    board.turn = Color.WHITE
    assert board.make_move(get_square_constant(0, 0), get_square_constant(5, 0)) is True
    ...
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(5, 0), get_square_constant(0, 0)) is True
    )  # Return rook
...
def test_castling_queenside_with_kingside_rook_only() -> None:
    ...
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(0, 7), get_square_constant(5, 7)) is True
    )  # Move rook away
...
def test_en_passant_white_captures_black_pawn() -> None:
    ...
    # White captures en passant (from rank 3 to rank 6)
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(2, 4), get_square_constant(5, 4)) is True
    )  # e4 captures en passant on e5

    # Verify: white pawn on e6 (row 6), black pawn removed from e7 (row 7)
    assert board.get_piece_type_at(get_square_constant(5, 4)) == PieceType.PAWN
    assert board.get_piece_type_at(get_square_constant(6, 4)) is None
...
def test_en_passant_black_captures_white_pawn() -> None:
    ...
    board.set_piece(
        get_square_constant(6, 5), create_piece(Color.BLACK, PieceType.PAWN)
    )  # Row 7 = rank 7 (f7)

    board.turn = Color.WHITE

    # White moves pawn two squares first (from rank 2 to rank 4)
    # Start at rank 2 (row 2), move to rank 4 (row 4), passing through rank 3 (row 3)
    assert board.make_move(get_square_constant(1, 4), get_square_constant(3, 4)) is True
    assert board.en_passant_target == get_square_constant(2, 4)

    # Black captures en passant immediately (f7 captures e3)
    # Black pawn at f7 (row 7, f-file) captures white pawn en passant on e3 (row 3, e-file)
    # This is a diagonal capture from f7 to e3
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(6, 5), get_square_constant(2, 4)) is True

    # Verify: black pawn on e3 (row 3), white pawn removed from e4 (row 4)
    assert board.get_piece_type_at(get_square_constant(2, 4)) == PieceType.PAWN
    assert board.get_piece_type_at(get_square_constant(3, 4)) is None

    # White moves (to change turn)
    board.turn = Color.WHITE
    board.set_piece(
        get_square_constant(0, 1), create_piece(Color.WHITE, PieceType.ROOK)
    )
    assert board.make_move(get_square_constant(0, 1), get_square_constant(0, 2)) is True
...
def test_en_passant_expires_after_non_pawn_move() -> None:
    ...
    assert board.make_move(get_square_constant(7, 1), get_square_constant(6, 2)) is True
...
def test_en_passant_cannot_capture_own_pawn() -> None:
    ...
    # Black moves pawn two squares
    assert board.make_move(get_square_constant(0, 4), get_square_constant(2, 4)) is True
    assert board.en_passant_target == get_square_constant(1, 4)

    # White tries to capture its own pawn en passant (should fail)
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(1, 4), get_square_constant(2, 3)) is False
    )
...
def test_promotion_from_rank_6_blocked() -> None:
    ...
    # White pawn on rank 7 cannot promote yet
    assert (
        board.make_move(get_square_constant(1, 4), get_square_constant(0, 4)) is False
    )
...
def test_absolute_pin_rook_cannot_move_forward() -> None:
    ...
    board.set_piece(
        get_square_constant(7, 4), create_piece(Color.BLACK, PieceType.QUEEN)
    )
    ...
    # Black moves (to change turn) - clear board for clean test
    board.turn = Color.BLACK
    clear_board(board)
    board.set_piece(
        get_square_constant(7, 0), create_piece(Color.BLACK, PieceType.ROOK)
...
def test_pinned_rook_can_be_captured() -> None:
    ...
    board.set_piece(
        get_square_constant(0, 3),
        create_piece(Color.BLACK, PieceType.KNIGHT),
    )

    # Black knight can capture pinned white rook
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(0, 3), get_square_constant(2, 4)) is True
    ...
    board.turn = Color.BLACK
    # Black pawn on d6 moves to d5 (rank 6 to rank 5)
    assert board.make_move(get_square_constant(5, 3), get_square_constant(4, 3)) is True
...
def test_relative_pin_piece_can_move() -> None:
    ...
    board.set_piece(
        get_square_constant(2, 4), create_piece(Color.WHITE, PieceType.QUEEN)
    )
    board.set_piece(
        get_square_constant(7, 4),
        create_piece(Color.BLACK, PieceType.BISHOP),
    ...
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(2, 4), get_square_constant(1, 4)) is True
...
def test_relative_pin_does_not_prevent_movement() -> None:
    ...
    board.turn = Color.WHITE
    assert board.make_move(get_square_constant(2, 4), get_square_constant(4, 5)) is True
...
def test_engine_handles_double_pin_gracefully() -> None:
    ...
    board.set_piece(
        get_square_constant(5, 3), create_piece(Color.BLACK, PieceType.ROOK)
    )
    ...
    # Should accept sideways move (doesn't expose king)
...
def test_king_can_move_into_pin() -> None:
    ...
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(0, 4), get_square_constant(0, 3)) is True
    )  # King can move
...
def test_king_can_move_out_of_pin() -> None:
    ...
    board.turn = Color.WHITE
    assert board.make_move(get_square_constant(0, 4), get_square_constant(0, 3)) is True
...
def test_checkmate_pinned_king() -> None:
    ...
    board.set_piece(
        get_square_constant(0, 6), create_piece(Color.WHITE, PieceType.PAWN)
    )
    board.set_piece(
        get_square_constant(0, 2), create_piece(Color.WHITE, PieceType.PAWN)
    )
    board.set_piece(
        get_square_constant(5, 7), create_piece(Color.BLACK, PieceType.PAWN)
    )
    ...
    board.turn = Color.BLACK
    board.set_piece(
        get_square_constant(5, 7), create_piece(Color.BLACK, PieceType.ROOK)
    )
    assert board.make_move(get_square_constant(5, 7), get_square_constant(5, 3)) is True
...
def test_stalemate_after_promotion() -> None:
    ...
    # Re-add blocking pawns (they were captured or moved)
    board.set_piece(
        get_square_constant(6, 3), create_piece(Color.WHITE, PieceType.PAWN)
    )
    board.set_piece(
    ...
    # Try to promote again - should fail because the pawn is already promoted to queen
    assert (
        board.make_move(
            get_square_constant(6, 4),
            get_square_constant(7, 4),
...
def test_rook_corner_moves_along_edge_only() -> None:
    ...
    # Rook on corner can move along both the rank and file (14 moves total)
    board.turn = Color.WHITE
    legal_moves = board.get_legal_moves()
...
def test_knight_corner_has_two_moves() -> None:
    ...
    # Knight on a1 has exactly 2 moves (b3, c2)
    board.turn = Color.WHITE
    legal_moves = board.get_legal_moves()
    assert len(legal_moves) == 2
    assert (ROW_3, COL_B) in [
        (m[1].row, m[1].col) for m in legal_moves
    ]  # b3 (row 3 = rank 3)
    assert (ROW_2, COL_C) in [
        (m[1].row, m[1].col) for m in legal_moves
    ]  # c2 (row 2 = rank 2)
...
def test_king_corner_has_three_moves() -> None:
    ...
    assert (ROW_1, COL_B) in [(m[1].row, m[1].col) for m in legal_moves]  # a1 -> b1
    assert (ROW_2, COL_A) in [(m[1].row, m[1].col) for m in legal_moves]  # a1 -> a2
    assert (ROW_2, COL_B) in [(m[1].row, m[1].col) for m in legal_moves]  # a1 -> b2
...
def test_knight_edge_has_reduced_moves() -> None:
    ...
    clear_board(board)
    board.set_piece(
        get_square_constant(5, 0),
        create_piece(Color.WHITE, PieceType.KNIGHT),
    )

    # Knight on a6 has 4 moves (fewer than 8 from center)
    board.turn = Color.WHITE
    legal_moves = board.get_legal_moves()
...
def test_black_pawn_on_rank_8_cannot_move_forward() -> None:
    """T6.3: Black pawn on rank 1 (row 7) cannot move backward (toward row 0)."""
    board = Board()
    clear_board(board)
    board.set_piece(
        get_square_constant(0, 4), create_piece(Color.BLACK, PieceType.PAWN)
    ...
    # Black pawn on rank 1 cannot move backward (toward row 0)
    board.turn = Color.BLACK
    assert (
        board.make_move(get_square_constant(0, 4), get_square_constant(7, 4)) is False
    )
...
def test_edge_rank_pawn_promotion_scenarios() -> None:
    ...
    # White pawn on rank 2 (row 2) can only move 1 or 2 squares forward (toward ROW_8)
    board.turn = Color.WHITE
    # Move to rank 3 (row 7) - one square move
    assert (
        board.make_move(get_square_constant(1, 4), get_square_constant(6, 4)) is True
    )  # e2-e3

    # Black moves (to change turn)
    board.turn = Color.BLACK
    board.set_piece(
        get_square_constant(7, 0), create_piece(Color.BLACK, PieceType.PAWN)
    )  # a7

    # Black pawn on rank 7 (row 8) can only move 1 or 2 squares forward (toward ROW_8)
    assert (
        board.make_move(get_square_constant(7, 0), get_square_constant(6, 0)) is True
    )  # a7-a6
...
def test_scholars_mate_sequence() -> None:
    ...
    board.clear_square(get_square_constant(0, 5))  # e7 - pawn was blocking diagonal
    board.clear_square(get_square_constant(5, 5))  # e6 - pawn was blocking diagonal
    board.set_piece(
        get_square_constant(0, 4), create_piece(Color.WHITE, PieceType.KING)
    )
    # Clear bishop's path
    ...
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(0, 6), get_square_constant(1, 5)) is True
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(1, 5), get_square_constant(2, 4)) is True
    board.turn = Color.BLACK
    assert board.make_move(get_square_constant(2, 4), get_square_constant(3, 3)) is True

    # Verify bishop is at d4 (4,3)
    piece = board.get_piece(get_square_constant(3, 3))
...
def test_intentional_stalemate_sequence() -> None:
    ...
    board.set_piece(
        get_square_constant(5, 5), create_piece(Color.BLACK, PieceType.ROOK)
    )  # f2
    board.set_piece(
        get_square_constant(0, 3), create_piece(Color.BLACK, PieceType.ROOK)
    )  # d1
    board.set_piece(
        get_square_constant(0, 5), create_piece(Color.BLACK, PieceType.ROOK)
    )  # f1
...
def test_multiple_en_passant_in_game() -> None:
    ...
    board.turn = Color.BLACK
    assert (
        board.make_move(get_square_constant(0, 5), get_square_constant(4, 5)) is True
    )  # f7-f5
    assert board.en_passant_target == get_square_constant(3, 5)
    board.turn = Color.WHITE
    # White pawn at e4 captures f5 en passant
    assert board.make_move(get_square_constant(4, 4), get_square_constant(3, 5)) is True
    ...
    board.turn = Color.BLACK
    assert (
        board.make_move(get_square_constant(0, 4), get_square_constant(4, 4)) is True
    )  # e7-e5
    assert board.en_passant_target == get_square_constant(3, 4)
    board.turn = Color.WHITE
    ...
    board.clear_square(get_square_constant(2, 5))  # Remove captured white pawn
    board.turn = Color.BLACK
    board.set_piece(
        get_square_constant(0, 5), create_piece(Color.BLACK, PieceType.PAWN)
    ...
    # The black pawn is now at (4,5) from the en passant move
    # Clear destination (3,5) before black moves pawn forward
    ...
    board.turn = Color.BLACK
    assert (
        board.make_move(get_square_constant(2, 5), get_square_constant(3, 5)) is True
    )  # f5-f6
...
def test_castling_blocked_if_destination_attacked() -> None:
    ...
    board.turn = Color.WHITE
    assert (
        board.make_move(get_square_constant(0, 4), get_square_constant(6, 6)) is False
    )

...
- [x] Push these moves earlier:
  - [x] prophylactic moves
  - [x] worst-piece improvements
  - [x] moves that suppress counterplay
  - [x] simplifying moves when clearly favorable
  - [x] structure-consistent plan moves

## 6.2 Push suspicious humanly-bad candidates later

- [x] Push these moves later:
  - [x] shelter-loosening pawn moves
  - [x] repeated heavy-piece shuffles
  - [x] speculative checks with easy replies
  - [x] pawn grabs that concede files or diagonals
  - [x] king moves that worsen coordination in middlegames
...
- [x] Add tests where ordering should prefer:
  - [x] prophylaxis over cosmetic activity
  - [x] safer simplification over speculative gain
  - [x] coordinated improvements over solo-piece heroics
  - [x] suppression of counterplay over a second-best attack

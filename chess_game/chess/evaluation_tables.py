...
CENTRAL_KING_WITH_QUEENS_PENALTY = 14
HEAVY_FILE_PRESSURE_PENALTY = 10
DEFENDER_DISTANCE_PENALTY = 6
EARLY_QUEEN_RAID_PENALTY = 16
EARLY_ROOK_MOVE_PENALTY = 7
EARLY_FLANK_RAID_PENALTY = 10
...
KING_SHELTER_LOOSENING_PENALTY = 10
